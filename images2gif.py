...
def _writeGifToFile(fp, images, durations, loops):
    ...
    for im in images:
        ...
        palettes.append(im.palette.getdata()[1]) # http://stackoverflow.com/questions/19149643/error-in-images2gif-py-with-globalpalette
...
def writeGif(filename, images, duration=0.1, loops=1, dither=1):
